...
LABEL org.opencontainers.image.description="Search and explore 1.8M+ US nonprofits, fetch Form 990 financials, and access IRS filing history via MCP. STDIO or Streamable HTTP."
...
RUN mkdir -p /var/log/nonprofit-explorer-mcp-server && chown -R bun:bun /var/log/nonprofit-explorer-mcp-server
...
ENV LOGS_DIR="/var/log/nonprofit-explorer-mcp-server"
